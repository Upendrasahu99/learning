...
while True:
    ...
    if parsed_response.get("step") == "think":
        # Make a Claude API Call and append the result as validate big task use big model and small task use small model to save token
        messages.append({ "role": "assistant", "content": "<>" })
        continue

    if parsed_response.get("step") != "result":
        # Make other LLM api call and append as result as validate, MultiModel agent
